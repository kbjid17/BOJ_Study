...
public class Main2 {
	...
	static PriorityQueue<gas> station = new PriorityQueue<gas>(Comparator.comparingInt(gas -> gas.d));
	static PriorityQueue<Integer> gaspq = new PriorityQueue<Integer>(Comparator.comparingInt(o -> -o));
	static int ans;
...
//		});
		...
		for (int i = 0; i < n; i++) {
			...
			station.offer(new gas(dist,fuel));
		}
